...
def sendInvite(userObj):
	...
	<html>
		...
		<body>
			...
			<br> %s has sent you a task via our task sharing and collaboration application Taskie. If you wish to collaborate 
			via Taskie, please download the Taskie app from Google Play Store<br>
			or simply click the link below.<br>
			<br><a href="https://play.google.com/store/apps/details?id=in.altersense.taskapp">Download from Google Play</a><br>
...
def passwordReset(userObj):
	...
	<html>
		...
		<body>
			...
			If the request was made by you, please visit the following link and provide a new password : <a href='%s'>Reset Password</a>.
