  ...
  <body>
		...
		<div class="container">
			<div class="row" id="about_intro">
				<div class="col-sm-12 col-md-12 col-lg-12" >
					...
					<h2>Task Sharing and Collaboration</h2>
					<p>Taskie is not a to-do list for you. Its a tool to share, collaborate and connect with the people around you.<br>Taskie is not about just sending tasks, it's more of a reminder with a more personal touch. </p>
		...
		<div class="container">
			<div class="row"  >
				...
				<div class="col-sm-6 col-md-6 col-lg-6" id="features_1_content">
					...
					<p>Taskie is desgined with the user's ease of navigation in mind. Send and review tasks with a few simple clicks
					</p>
					<div class="feature">
						<svg viewBox="0 0 32 32" class="feature_icon">
						<use xlink:href="#graph-pie1"></use></svg>
						<div>
							<h4>Easy list navigation</h4>
							<p>Navigate through your tasks<br>with a tap, swipe and slide</p>
						</div>
					</div>
					...
					<div class="feature">
						...
						<div>
							<h4>Elegant User Experience</h4>
							<p>Designed with the simplest of interfaces<br>to perform advanced features.</p>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-6" id="features_2_content">
					...
					<p>Taskie ensures that you and the people you connect with are kept in a constant loop about the tasks and its progress, with prompt feedback and status updates.
					</p>
					<div class="feature">
						<svg viewBox="0 0 32 32" class="feature_icon">
						...
						<div>
							...
							<p>Recieve quick and prompt updates about you tasks<br>via push and list notifications</p>
						</div>
					</div>
					...
					<div class="feature">
						...
						<div>
							...
							<p>Send tasks to not just one<br>but with many people at a time.</p>
						</div>
					</div>
	...
	<section id="footer">
		<div class="container">		   
		   	<div class="row">
		   		<div class="col-sm-6 col-md-6 col-lg-6">
		   			<p>Copyright &copy; All Rights Reserved - Taskie</p>
		   		</div>
		   		<div class="col-sm-6 col-md-6 col-lg-6">
		   			<p>A product of Altersense India</p>
		   		</div>
		  	</div>
		</div>
	</section>
