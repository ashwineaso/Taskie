...
<html>
  	<head>
		...
		<link href="nivo-lightbox.css" rel="stylesheet" media="screen">
		<link href="nivo_lightbox_themes/default/default.css" rel="stylesheet" media="screen">
		<link href="colors/red.css" rel="stylesheet" media="screen">
